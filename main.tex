...
We mainly introduce existing link range experiments / upper limits. So this is new information, it must not go in the conclusion. But it's also very close to deriving conclusions from our work. Should I mention these values in the introduction or implementation/methodology or Related Work?

\section{Conclusion}\label{sec:conclusion}
Put measured values from Related Work in relation to our results (ch:discussion from thesis)
