...
NVIDIA and other graphics processing unit producers offer dedicated ray-tracing (RT) offloading cores and SDKs. For instance, NVIDIA RTX GPUs can be programmed with the OptiX SDK by building a BVH (bounding volume hierarchy) acceleration structure (AS) in memory and running line-of-sight checks against that almost entirely in hardware\todo{cite OptiX}.
